...
Ce fichier contient les vues permettant d'afficher la liste des locations et
les détail d'une location spécifique
"""
...
def index(request):
    ...
    Récupère toutes les locations enregistrées et les passe au template
    'lettings/index.html'
...
def letting(request, letting_id):
    ...
    Récupère une location à partir de son identifiant et affiche ses
    informations dans le template
