...
l'application Django dans un environnement asynchrone. Il définit l'application ASGI
en utilisant la méthode `get_asgi_application`, ce qui permet la gestion des connexions
asynchrones, comme WebSockets ou HTTP/2.
"""
import os
